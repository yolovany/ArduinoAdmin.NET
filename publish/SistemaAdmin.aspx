<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SistemaAdmin.aspx.cs" Inherits="BookingSystem.SistemaAdmin" %>

<%@ Register Src="~/controls/editProductsForm.ascx" TagPrefix="uc1" TagName="editProductsForm" %>
<%@ Register Src="~/controls/lstProductsForm.ascx" TagPrefix="uc1" TagName="lstProductsForm" %>
<%@ Register Src="~/controls/editUserForm.ascx" TagPrefix="uc1" TagName="editUserForm" %>
<%@ Register Src="~/controls/lstUsersAdmin.ascx" TagPrefix="uc1" TagName="lstUsersAdmin" %>
...
<%@ Register Src="~/controls/TimelineBookForm.ascx" TagPrefix="uc1" TagName="TimelineBookForm" %>
...
<%@ Register Src="~/controls/lstPriceRooms.ascx" TagPrefix="uc1" TagName="lstPriceRooms" %>
<%@ Register Src="~/controls/editPriceRoomsForm.ascx" TagPrefix="uc1" TagName="editPriceRoomsForm" %>
                ...
                <div class="wrapper">
                    ...
                    <main class="main--container">
                        ...
                        <section class="main--content">
                            <uc1:editProductsForm runat="server" ID="editProductsForm" />
                            <uc1:lstProductsForm runat="server" ID="lstProductsForm" />
                            <uc1:lstUsersAdmin runat="server" ID="lstUsersAdmin" />
                            <uc1:editUserForm runat="server" ID="editUserForm" />
                            ...
                            <uc1:TimelineBookForm runat="server" ID="TimelineBookForm" />
                            ...
                            <uc1:lstPriceRooms runat="server" ID="lstPriceRooms" />
                            <uc1:editPriceRoomsForm runat="server" ID="editPriceRoomsForm" />
                        </section>
                        <!-- Main Content End -->
